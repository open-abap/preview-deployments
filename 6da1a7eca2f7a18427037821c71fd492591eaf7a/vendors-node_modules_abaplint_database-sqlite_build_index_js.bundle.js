...
const sql_wasm_debug_1 = __webpack_require__(/*! sql.js/dist/sql-wasm-debug */ "./node_modules/sql.js/dist/sql-wasm-debug.js");
class SQLiteDatabaseClient {
    ...
    async connect(data) {
        var _a, _b;
        const SQL = await (0, sql_wasm_debug_1.default)();
        this.sqlite = new SQL.Database(data);
        // @ts-ignore
        if (((_a = abap === null || abap === void 0 ? void 0 : abap.context) === null || _a === void 0 ? void 0 : _a.databaseConnections) && abap.context.databaseConnections["DEFAULT"] === this) {
            // @ts-ignore
            (_b = abap.builtin.sy.get().dbsys) === null || _b === void 0 ? void 0 : _b.set(this.name);
        }
    }
    async disconnect() {
        this.sqlite.close();
...
requireNodeFS = () => {
  ...
  // created.
  if (!nodePath) {
    fs = __webpack_require__(/*! fs */ "?5041");
    nodePath = __webpack_require__(/*! path */ "./node_modules/path-browserify/index.js");
  }
};
